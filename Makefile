...
test-e2e-smoke: manifests generate fmt vet ## Run smoke e2e tests
	...
	WVA_NAMESPACE=$${WVA_NAMESPACE:-$(CONTROLLER_NAMESPACE)} \
	...
	USE_SIMULATOR=$${USE_SIMULATOR:-$(USE_SIMULATOR)} \
	SCALE_TO_ZERO_ENABLED=$${SCALE_TO_ZERO_ENABLED:-$(SCALE_TO_ZERO_ENABLED)} \
